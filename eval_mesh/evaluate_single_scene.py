...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_mesh', type=str,  default='', help='path to the mesh to be evaluated')
    # parser.add_argument('--scan_id', type=str,  default='mask',  help='scan id of the input mesh')
