...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default=r'D:\wyh\eval_mvs\dtu122\eval_dtu\culled_mesh.ply')
    parser.add_argument('--scan', type=int, default=122)
    parser.add_argument('--mode', type=str, default='mesh', choices=['mesh', 'pcd'])
    parser.add_argument('--dataset_dir', type=str, default=r"D:\wyh\dtu\SampleSet\SampleSet\MVS Data")
    parser.add_argument('--vis_out_dir', type=str, default=r'D:\wyh\eval_mvs\dtu122\eval_dtu')
